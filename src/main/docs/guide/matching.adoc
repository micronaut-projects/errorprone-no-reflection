...
Calling the methods of a `java.lang.reflect` object that is already at hand to read its name, modifiers or declared types is not reported: looking it up was.
